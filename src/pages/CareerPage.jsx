...
const CareerPage = () => {
  ...
  const careers = [
    ...
    },
    {
      _id: 2,
      role: "UI/UX Designer",
      qualifications: "Figma, UI principles",
      applicants: 3,
      number_of_posts: 1,
      image: "/career2.jpg",
    },
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta property="og:url" content="https://dreamsansar.com/careers" />
      </Helmet>
      ...
      <Box bg="gray.50" minH="100vh">
        ...
        <Box
          position="relative"
          bgImage={`linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('${header3}')`}
          bgSize="cover"
          bgPos="center"
          py={{ base: 20, md: 28 }}
          textAlign="center"
        ...
        >
          ...
          <Text fontSize="lg" mt={4} maxW="600px" mx="auto">
            We’re looking for passionate people to help us build innovative
        ...
        <Box py={20} textAlign="center" bg="white">
          ...
          <SimpleGrid columns={{ base: 1, md: 4 }} spacing={10} mt={10} px={10}>
            {[
              {
                title: "Career Growth",
                desc: "Opportunities to learn and grow continuously.",
              },
              {
                title: "Flexible Work",
                desc: "Hybrid and remote work options.",
              },
              {
                title: "Great Culture",
                desc: "A supportive and inclusive workplace.",
              },
              {
                title: "Innovation First",
                desc: "We encourage creativity and experimentation.",
              },
            ].map((perk) => (
              <Box
                key={perk.title}
